...
- **Practice Studio** — unlimited generated questions across 50 topics (algebra, quadratics, coordinate geometry, circles, functions, trig, calculus, vectors, matrices, statistics, partial fractions and more), each with step-by-step worked solutions and a diagram drawn from the actual numbers in your question: the real parabola with its roots marked, the triangle to scale, your two points with the midpoint between them, the circle at its actual centre and radius, asymptotes, Argand diagrams, bar charts.
