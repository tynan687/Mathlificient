...
const SUITES = [
  ...
  { name: 'marking', cmd: ['tools/check-marking.js'], node: true,
    what: 'the tutor verdict: right / wrong / unsure' },
  { name: 'slips', cmd: ['tools/check-slips.js'], node: true,
  ...
  { name: 'windows', cmd: ['tools/check-windows.js'], node: true,
    what: 'window wiring, focus, throttling and failure reporting' },
